...
par(mfcol=c(2,2))
# first subplot
with(elec, plot(DateTime, Global_active_power, type="l", xlab="", ylab="Global Active Power"))
# second subplot
...
# third subplot
with(elec, plot(DateTime, Voltage, type="l", xlab="datetime", ylab="Voltage"))
# fourth subplot
with(elec, plot(DateTime, Global_reactive_power, type="l", col="black", xlab="datetime"))
dev.off()